...
export default async function Om() {
  ...
  return (
    <div className="md:absolute flex flex-col-reverse md:flex-row-reverse items-center md:gap-[24px] pt-[84px] md:pt-0 md:top-[64px] md:h-[calc(100vh-73px-54px-10px)] side-spacing">
      <div className="md:w-1/2 flex flex-col gap-[24px] py-[24px]">
        <h1 className="text-4xl font-bold">Om mig</h1>
